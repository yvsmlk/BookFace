...
const Home = () => {
  ...
  React.useEffect(() => {
    ...
    return (
      ...
      <div className=' flex flex-1  overflow-scroll 'style={backgroundImageStyle}>
       ...
       <div className='flex flex-wrap mt-2 md:flex-1'>
        {/* Partie gauche */}
        <div className='w-full mb-2 md:ml-2 xl:ml-0 '>
  ...
  {/* Partie du milieu */}
  <div className='w-full sm:w-full md:w-1/2 lg:w-1/3 xl:w-1/2 p-4'>
    {/* Code fourni */}
    <div className='max-w-2xl min-h-screen mx-auto rounded-md overflow-hidden shadow-md '>
  ...
  {/* Partie droite */}
  <div className=' w-full md:w-4/5 xl:flex-1 sm:w-auto sm:flex-none md:w-1/4 lg:w-1/3 xl:w-1/4 p-4'>
  <div className="mb-2 md:ml-2 xl:ml-0">
      <SearchBar />
    </div>
    <div className="mb-2 md:ml-2 xl:ml-0">
